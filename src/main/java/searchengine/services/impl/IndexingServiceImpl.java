...
public class IndexingServiceImpl implements IndexingService {
    ...
    public boolean urlIndexing(String url) {
        if (urlCheck(url)) {
            ...
            executorService.submit(new IndexingSite(pageRepository, siteRepository, lemmaRepository, indexSearchRepository, lemmaParserInterface, indexParserInterface, url, sitesList));
