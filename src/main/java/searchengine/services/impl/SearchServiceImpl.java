...
public class SearchServiceImpl implements SearchService {
    ...
    @Override
    public List<StatisticsSearchDto> allSiteSearch(String searchText, int offset, int limit) {
        ...
        List<StatisticsSearchDto> searchData = null;
    ...
    @Override
    public List<StatisticsSearchDto> siteSearch(String searchText, String url, int offset, int limit) {
    ...
    private List<StatisticsSearchDto> getSearchData(Hashtable<Page, Float> pageList, List<String> textLemmaList) {
        List<StatisticsSearchDto> result = new ArrayList<>();
        ...
        for (Page page : pageList.keySet()) {
            ...
            result.add(new StatisticsSearchDto(site, siteName, uri, title, snippet, absRelevance));
        }
        return result;
    }
    ...
    private List<StatisticsSearchDto> getSearchDtoList(List<Lemma> lemmaList, List<String> textLemmaList, int offset, int limit) {
        List<StatisticsSearchDto> result = new ArrayList<>();
        ...
        if (lemmaList.size() >= textLemmaList.size()) {
            ...
            List<StatisticsSearchDto> dataList = getSearchData(sortedPageByAbsRelevance, textLemmaList);
